...
def main(args):
    ...
    model_densenet121 = DenseNet121_LP(num_classes=0)
    ...
    macs, params = profile(model_densenet121, inputs=(dummy,), verbose=False)
    flops = 2 * macs
    logging.info(
    ...
    for strategy in strats:
        fine_tune_densenet(device, train_loader, val_loader, classes, strategy, args.lr, args.epochs, args.plot_path)
        torch.cuda.empty_cache()
