...
def plot_val_accuracy_bar(results, strategy, plot_path):
    path = plot_path + f"val_acc_bar_{strategy}.pdf"
...
def plot_train_val_gap(gaps, strategy, plot_path):
    path = plot_path + f"val_gap_{strategy}.pdf"
